...
public class Lab4bai1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lab4bai1);
        ...
        btnDangKy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Lab4bai1.this, "Nhập lại ! Vui lòng nhập đủ thông tin !", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(Lab4bai1.this, "Tên của bạn là: " + tenCuaBan + "Tên đăng nhập là: " + tenDangNhap + "Mật khẩu là: " + matKhau + "SDT là " + SDT, Toast.LENGTH_SHORT).show();
                }
                AlertDialog.Builder dialog = new AlertDialog.Builder(Lab4bai1.this);
