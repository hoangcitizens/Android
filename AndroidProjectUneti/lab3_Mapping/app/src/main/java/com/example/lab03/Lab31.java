        ...
        btnGui.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (hoTen.isEmpty() && cmnd.isEmpty() && !isTrungCap && !isCaoDang && !isDaiHoc && !isDocSach && !isDocBao && !isCoding) {
                    Toast.makeText(Lab31.this, "Vui lòng nhập thông tin hộ tên, cmnd, chọn trình độ học vấn, chọn ít nhất 1 Sở thích", Toast.LENGTH_SHORT).show();
                } else if (cmnd.isEmpty() && !isTrungCap && !isCaoDang && !isDaiHoc && !isDocSach && !isDocBao && !isCoding) {
                    Toast.makeText(Lab31.this, "Vui lòng nhập thông tin cmnd, chọn trình độ học vấn, chọn ít nhất 1 Sở thích", Toast.LENGTH_SHORT).show();
                } else if (hoTen.isEmpty() && !isTrungCap && !isCaoDang && !isDaiHoc && !isDocSach && !isDocBao && !isCoding) {
                    Toast.makeText(Lab31.this, "Vui lòng nhập thông tin họ tên, chọn trình độ học vấn, chọn ít nhất 1 Sở thích", Toast.LENGTH_SHORT).show();
                } else if (!isTrungCap && !isCaoDang && !isDaiHoc && !isDocSach && !isDocBao && !isCoding) {
                    Toast.makeText(Lab31.this, "Vui lòng chọn trình độ học vấn và chọn ít nhất 1 Sở thích", Toast.LENGTH_SHORT).show();
                } else if (hoTen.isEmpty() && !isTrungCap && !isCaoDang && !isDaiHoc) {
                    Toast.makeText(Lab31.this, "Vui lòng nhập thông tin hộ tên và chọn trình độ học vấn", Toast.LENGTH_SHORT).show();
                } else if (hoTen.isEmpty() && !isDocSach && !isDocBao && !isCoding) {
                    Toast.makeText(Lab31.this, "Vui lòng nhập thông tin hộ tên và chọn ít nhất 1 sở thích", Toast.LENGTH_SHORT).show();
                } else if (cmnd.isEmpty() && !isTrungCap && !isCaoDang && !isDaiHoc) {
                    Toast.makeText(Lab31.this, "Vui lòng nhập thông tin cmnd và chọn trình độ học vấn", Toast.LENGTH_SHORT).show();
                } else if (cmnd.isEmpty() && !isDocSach && !isDocBao && !isCoding) {
                    Toast.makeText(Lab31.this, "Vui lòng nhập thông tin cmnd và chọn ít nhất 1 sở thích", Toast.LENGTH_SHORT).show();
                } else if (hoTen.isEmpty() && cmnd.isEmpty()) {
                    Toast.makeText(Lab31.this, "Vui lòng nhập thông tin hộ tên và cmnd", Toast.LENGTH_SHORT).show();
                } else if (hoTen.isEmpty()) {
                    Toast.makeText(Lab31.this, "Vui lòng nhập thông tin họ tên", Toast.LENGTH_SHORT).show();
                } else if (cmnd.isEmpty()) {
                    Toast.makeText(Lab31.this, "Vui lòng nhập thông tin cmnd", Toast.LENGTH_SHORT).show();
                    ...
                    AlertDialog.Builder dialog = new AlertDialog.Builder(Lab31.this);
